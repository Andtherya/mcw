...
export ARGO_PORT=${ARGO_PORT:-'34986'}         # argo端口 使用固定隧道token,cloudflare后台设置的端口需和这里对应
...
MHcCAQEEIEIPjisFm+VsPxaTMqTmoDiuWJsTOFq3KYZ9GIGeFEtLoAoGCCqGSM49
AwEHoUQDQgAErswhiIS/SpBKYJ4d6hm6W7iFrOoY3We0yjr0gpUZETRAIYZT902k
aHVg5XjlbYAhF1TI49JQ8T0YRaagsKvS8g==
-----END EC PRIVATE KEY-----
EOF
    ...
    cat > "cert.pem" << 'EOF'
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
EOF
fi
  ...
  "endpoints": [
    {
      ...
      "address": [
        "172.16.0.2/32",
        "2606:4700:110:8464:764b:bc80:b3ed:509f/128"
      ],
